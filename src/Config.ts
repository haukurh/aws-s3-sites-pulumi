...
const cloudfrontRefererBase64 = Buffer.from(cloudfrontReferer, 'utf8').toString('base64');
...
const tags = projectTags !== undefined
    ? {...defaultTags, ...projectTags}
    : defaultTags;

// Default policy: AWS Managed-CachingOptimized
const cloudfrontCachePolicyId = projectConfig.get<string>('cloudfrontCachePolicyId')
